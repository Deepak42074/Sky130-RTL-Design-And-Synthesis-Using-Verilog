...
- [Day1 - Introduction to Verilog RTL Design and Synthesis](#Day1---Introduction-to-Verilog-RTL-Design-and-Synthesis)
   ...
   7. [Synthesis with Yosys](#Synthesis-with-yosys)
   	1. [Yosys Synthesis Flow setup](#Yosys-Synthesis-Flow-setup)
   	2. [Verifying the Synthesis output netlist](#Verifying-the-Synthesis-output-netlist)
...
- [Day2 - Timing libs, hierarchical vs flat synthesis and efficient flop coding styles](#Day2---Timing-libs-,-hierarchical-vs-flat-synthesis-and-efficient-flop-coding-styles)
   1. [Introduction to Timing .libs](#Introduction-to-Timing-.libs)
	a. [Library naming convention](#Library-naming-convention)
	b. [Liberty file(.lib)](#Liberty-file-(-.lib-))
  2. [Hierarchical and Flat synthesis](# Hierarchical-and-Flat-synthesis)
	 a. [Hierarchial synthesis](#Hierarchial-synthesis)
	 b. [Flat Synthesis](#Flat-Synthesis)
	 c. [Submodule Level Synthesis](#Submodule-Level-Synthesis)
   3. [Flop coding styles and optimization](#Flop-coding-styles-and-optimization)
   		a. [Different Flop coding styles](#Different-Flop-coding-styles)
- [Day3 - Combinational and Sequential optimizations](#Day3---Combinational-and-Sequential-optimizations)
   ...
   2.[Combinational Logic Optimizations](#Combinational-Logic-Optimizations)
   	 	a. [Constant Propagation](#Constant_Propagation)
		b. [Boolean Logic Optimization](#Boolean-Logic-Optimization)
   3.[Sequential Logic Optimizations](#Sequential-Logic-Optimizations)
   		a. [Sequential Constant Propagation](#Sequential-Constant-Propagation)
		b. [Advanced Techniques](#Advanced-Techniques)
   4.[Logic optimizations with Yosys](#Logic-optimizations-with-Yosys)
		a. [ Combinational Logic Optimizations](#Combinational-Logic-Optimizations)
		b. [Sequential Logic Optimizations](#Sequential-Logic-Optimizations)
...
- [GLS, blocking vs non-blocking and Synthesis-Simulation mismatch](#GLS-,-blocking-vs-non---blocking-and-Synthesis---Simulation-mismatch)
   ...
   3. [Synthesis-Simulation Mismatch](#Synthesis---Simulation-Mismatch)
   		a. [Missing Sensitivity list](#Missing-Sensitivity-list)	
		b. [Blocking and Non-blocking assignments in verilog](#Blocking-and-Non---blocking-assignments-in-verilog)
